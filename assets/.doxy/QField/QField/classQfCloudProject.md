...
| signal void | [**isSharedDatasetsProjectChanged**](classQfCloudProject.md#signal-isshareddatasetsprojectchanged)  <br> |
...
```C++
void QfCloudProject::isSharedDatasetsProjectChanged;
```
...
```C++
inline bool QfCloudProject::isSharedDatasetsProject () const
```
...
```C++
void QfCloudProject::setIsSharedDatasetsProject (
