...
| property QML\_ELEMENT [**Qf3DTerrainProvider**](classQf3DTerrainProvider.md) \* | [**terrainProvider**](classQfMapToView3D.md#property-terrainprovider-12)  <br>_The terrain provider used for geo-to-3D coordinate conversion._  |
...
```C++
QML_ELEMENT Qf3DTerrainProvider * QfMapToView3D::terrainProvider;
```
