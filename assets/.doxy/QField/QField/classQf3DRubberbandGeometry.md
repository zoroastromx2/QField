...
| property QML\_ELEMENT [**QfRubberbandModel**](classQfRubberbandModel.md) \* | [**rubberbandModel**](classQf3DRubberbandGeometry.md#property-rubberbandmodel-12)  <br>_The rubberband model providing the vertex coordinates._  |
...
```C++
QML_ELEMENT QfRubberbandModel * Qf3DRubberbandGeometry::rubberbandModel;
```
