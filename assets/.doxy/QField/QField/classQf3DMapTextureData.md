...
| property QML\_ELEMENT [**QgsQuickMapSettings**](classQgsQuickMapSettings.md) \* | [**mapSettings**](classQf3DMapTextureData.md#property-mapsettings-12)  <br>_The map settings from which to get layers, extent, and output size for rendering._  |
...
```C++
QML_ELEMENT QgsQuickMapSettings * Qf3DMapTextureData::mapSettings;
```
