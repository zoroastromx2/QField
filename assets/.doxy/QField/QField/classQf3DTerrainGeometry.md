...
| property QML\_ELEMENT QSize | [**gridSize**](classQf3DTerrainGeometry.md#property-gridsize-12)  <br>_Grid dimensions (width x height) for terrain vertices._  |
...
```C++
QML_ELEMENT QSize Qf3DTerrainGeometry::gridSize;
```
